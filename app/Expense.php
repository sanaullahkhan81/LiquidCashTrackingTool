...
class Expense extends Model
{
    ...
    protected $fillable = ['entry_date', 'amount', 'expenses_category_id','cur_id','cur_amount','description'];
    ...
    static function accumulateExpenseWithDate($date){
        
        $expenseAmount  = Expense::where('entry_date', $date)->sum('amount');
