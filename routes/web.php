...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::resource('custom_reports', 'custom_reports');
    Route::post('getreport/{date}','custom_reports@getreport');
    Route::post('custom_reports','custom_reports@store');
    Route::post('storeClosing','custom_reports@storeClosing');
    Route::resource('currencies', 'CurrenciesController');
    Route::resource('curBalance', 'CurBalanceController');
